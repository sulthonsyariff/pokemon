    ...
    >
      <div>
        <div className='flex flex-col-reverse sm:flex-row justify-between'>
          <div className='font-bold pb-5 text-lg capitalize leading-6'>
            {item.name}
          </div>
          <div className='text-xs font-medium italic opacity-60'>
            #{addPad(number)}
          </div>
        </div>
      ...
      <img
        src='/pokeball.png'
        className='w-24 absolute -bottom-4 -right-4 opacity-30'
        alt='bg-pokeball'
      />
